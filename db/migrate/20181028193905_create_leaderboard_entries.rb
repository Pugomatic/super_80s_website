class CreateLeaderboardEntries < ActiveRecord::Migration[5.2]
  def change
    ...
    add_column  :leaderboards, :joiner_tables, :string, default: 'players'
    ...
    Leaderboard.last.update_attributes sorting: 'levels.number DESC, value DESC', joiner_tables: 'levels,players', metric: 'high_score', timeframe: 'game'
  end
end
