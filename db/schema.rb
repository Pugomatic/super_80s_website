...
ActiveRecord::Schema.define(version: 20180915152854) do
  ...
  add_index "player_totals", ["player_id"], name: "i_player_totals_p", using: :btree
  ...
  add_index "player_worlds", ["player_id", "world_id"], name: "i_player_worlds_pw", using: :btree
  add_index "player_worlds", ["player_id"], name: "i_player_worlds_p", using: :btree
